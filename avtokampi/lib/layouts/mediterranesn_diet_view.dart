...
class MediterranesnDietView extends StatelessWidget {
    ...
    getStRezervacijForUser() {
        int stRezervacij = 0;
        for (Rezervacija rezervacija in globals.rezervacije) {
            if (rezervacija.uporabnik == globals.currentUser.id) {
                stRezervacij++;
            }
        }
        return stRezervacij;
    ...
    getStMnenjForUser() {
        ...
        for (Mnenje mnenje in globals.mnenja) {
            if (mnenje.uporabnik == globals.currentUser.id) {
                stMnenj++;
            }
        }
        return stMnenj;
...
class CurvePainter extends CustomPainter {
    ...
    void paint(Canvas canvas, Size size) {
        ...
        canvas.drawArc(
            new Rect.fromCircle(
                center: shdowPaintCenter, radius: shdowPaintRadius),
            degreeToRadians(278),
